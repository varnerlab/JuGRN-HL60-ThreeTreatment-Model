...
for count = collect(1:3)
  ...
  time_AhR = [0.0 48.0]
  (raw_data_AhR,scaled_data_AhR,scaled_state_AhR,raw_state_AhR) = process_ensemble_data(path_to_sim_files,time_AhR,40);
  ...
  (raw_data_CD38,scaled_data_CD38,scaled_state_CD38,raw_state_CD38) = process_ensemble_data(path_to_sim_files,time_CD38,43);
  ...
  (raw_data_CD14,scaled_data_CD14,scaled_state_CD14,raw_state_CD14) = process_ensemble_data(path_to_sim_files,time_CD14,42);
  ...
  (raw_data_CD11b,scaled_data_CD11b,scaled_state_CD11b,raw_state_CD11b) = process_ensemble_data(path_to_sim_files,time_CD11b,41);
  ...
  (raw_data_P47Phox,scaled_data_P47Phox,scaled_state_P47Phox,raw_state_P47Phox) = process_ensemble_data(path_to_sim_files,time_P47Phox,52);
  ...
  time_EGR1 = [0.0 48.0]
  (raw_data_EGR1,scaled_data_EGR1,scaled_state_EGR1,raw_state_EGR1) = process_ensemble_data(path_to_sim_files,time_EGR1,46);
  ...
  time_IRF1 = [0.0 48.0]
  (raw_data_IRF1,scaled_data_IRF1,scaled_state_IRF1,raw_state_IRF1) = process_ensemble_data(path_to_sim_files,time_IRF1,48);
  ...
  time_GIF1 = [0.0 48.0]
  (raw_data_GIF1,scaled_data_GIF1,scaled_state_GIF1,raw_state_GIF1) = process_ensemble_data(path_to_sim_files,time_GIF1,47);
  ...
  time_PU1 = [0.0 48.0]
  (raw_data_PU1,scaled_data_PU1,scaled_state_PU1,raw_state_PU1) = process_ensemble_data(path_to_sim_files,time_PU1,54);
  ...
  time_OCT4 = [0.0 48.0]
  (raw_data_OCT4,scaled_data_OCT4,scaled_state_OCT4,raw_state_OCT4) = process_ensemble_data(path_to_sim_files,time_OCT4,50);
  ...
  time_CEBPa = [0.0 48.0]
  (raw_data_CEBPa,scaled_data_CEBPa,scaled_state_CEBPa,raw_state_CEBPa) = process_ensemble_data(path_to_sim_files,time_CEBPa,44);
  ...
  (raw_data_E2F,scaled_data_E2F,scaled_state_E2F,raw_state_E2F) = process_ensemble_data(path_to_sim_files,time_E2F,45);
