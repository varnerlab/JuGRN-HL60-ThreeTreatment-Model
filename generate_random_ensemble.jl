...
random_ensemble = lower_bound_array*ones(1,number_of_final_sets) + rand(167,number_of_final_sets).* (upper_bound_array-lower_bound_array)
for parameter_set_index = 1:number_of_final_sets

  # sample the parameter array -
  parameter_array = random_ensemble[:,parameter_set_index]
...
for (local_index,parameter_set_index) in enumerate(ensemble_index_array)
  ...
  data_filename = "../../Documents/HL60_STATES/random_ensemble_v1/RA/sim_data_PSI_"*string(parameter_set_index)*"_RA.dat"
  writedlm(data_filename,local_data_RA);
  data_filename = "../../Documents/HL60_STATES/random_ensemble_v1/D3/sim_data_PSI_"*string(parameter_set_index)*"_D3.dat"
  writedlm(data_filename,local_data_D3);
  data_filename = "../../Documents/HL60_STATES/random_ensemble_v1/RA_D3/sim_data_PSI_"*string(parameter_set_index)*"_RA_D3.dat"
  writedlm(data_filename,local_data_RA_D3);
end

# Write the simple ensemble -
filename = "../../Documents/HL60_STATES/random_ensemble_v1/simple_ensemble_parameter_sets.dat"
writedlm(filename,ensemble_array);

# Write the simple ensemble -
filename = "../../Documents/HL60_STATES/random_ensemble_v1/objective_archive.dat"
