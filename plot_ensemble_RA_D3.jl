...
#=
CD11b_array_scaled = readdlm("./plot_simple/scaled_state_CD11b_RA_D3.dat");
CD38_array_scaled = readdlm("./plot_simple/scaled_state_CD38_RA_D3.dat");
AhR_array_scaled = readdlm("./plot_simple/scaled_state_AhR_RA_D3.dat");
P47Phox_array_scaled = readdlm("./plot_simple/scaled_state_P47Phox_RA_D3.dat");
IRF1_array_scaled = readdlm("./plot_simple/scaled_state_IRF1_RA_D3.dat");
EGR1_array_scaled = readdlm("./plot_simple/scaled_state_EGR1_RA_D3.dat");
PU1_array_scaled = readdlm("./plot_simple/scaled_state_PU1_RA_D3.dat");
GIF1_array_scaled = readdlm("./plot_simple/scaled_state_GIF1_RA_D3.dat");
E2F_array_scaled = readdlm("./plot_simple/scaled_state_E2F_RA_D3.dat");
CEBPa_array_scaled = readdlm("./plot_simple/scaled_state_CEBPa_RA_D3.dat");
OCT4_array_scaled = readdlm("./plot_simple/scaled_state_OCT4_RA_D3.dat");

# interpreated simulation data to match times of data
CD11b_data_scaled = readdlm("./plot_simple/scaled_data_CD11b_RA_D3.dat");
CD38_data_scaled = readdlm("./plot_simple/scaled_data_CD38_RA_D3.dat");
AhR_data_scaled = readdlm("./plot_simple/scaled_data_AhR_RA_D3.dat");
P47Phox_data_scaled = readdlm("./plot_simple/scaled_data_P47Phox_RA_D3.dat");
IRF1_data_scaled = readdlm("./plot_simple/scaled_data_IRF1_RA_D3.dat");
EGR1_data_scaled = readdlm("./plot_simple/scaled_data_EGR1_RA_D3.dat");
PU1_data_scaled = readdlm("./plot_simple/scaled_data_PU1_RA_D3.dat");
GIF1_data_scaled = readdlm("./plot_simple/scaled_data_GIF1_RA_D3.dat");
E2F_data_scaled = readdlm("./plot_simple/scaled_data_E2F_RA_D3.dat");
CEBPa_data_scaled = readdlm("./plot_simple/scaled_data_CEBPa_RA_D3.dat");
OCT4_data_scaled = readdlm("./plot_simple/scaled_data_OCT4_RA_D3.dat");
=#
# load data from best ensemble

CD11b_array_scaled = readdlm("./plot_best/scaled_state_CD11b_RA_D3.dat");
CD38_array_scaled = readdlm("./plot_best/scaled_state_CD38_RA_D3.dat");
CD14_array_scaled = readdlm("./plot_best/scaled_state_CD14_RA_D3.dat");
AhR_array_scaled = readdlm("./plot_best/scaled_state_AhR_RA_D3.dat");
P47Phox_array_scaled = readdlm("./plot_best/scaled_state_P47Phox_RA_D3.dat");
IRF1_array_scaled = readdlm("./plot_best/scaled_state_IRF1_RA_D3.dat");
EGR1_array_scaled = readdlm("./plot_best/scaled_state_EGR1_RA_D3.dat");
PU1_array_scaled = readdlm("./plot_best/scaled_state_PU1_RA_D3.dat");
GIF1_array_scaled = readdlm("./plot_best/scaled_state_GIF1_RA_D3.dat");
E2F_array_scaled = readdlm("./plot_best/scaled_state_E2F_RA_D3.dat");
CEBPa_array_scaled = readdlm("./plot_best/scaled_state_CEBPa_RA_D3.dat");
OCT4_array_scaled = readdlm("./plot_best/scaled_state_OCT4_RA_D3.dat");

# interpreated simulation data to match times of data
CD11b_data_scaled = readdlm("./plot_best/scaled_data_CD11b_RA_D3.dat");
CD38_data_scaled = readdlm("./plot_best/scaled_data_CD38_RA_D3.dat");
CD14_data_scaled = readdlm("./plot_best/scaled_data_CD14_RA_D3.dat");
AhR_data_scaled = readdlm("./plot_best/scaled_data_AhR_RA_D3.dat");
P47Phox_data_scaled = readdlm("./plot_best/scaled_data_P47Phox_RA_D3.dat");
IRF1_data_scaled = readdlm("./plot_best/scaled_data_IRF1_RA_D3.dat");
EGR1_data_scaled = readdlm("./plot_best/scaled_data_EGR1_RA_D3.dat");
PU1_data_scaled = readdlm("./plot_best/scaled_data_PU1_RA_D3.dat");
GIF1_data_scaled = readdlm("./plot_best/scaled_data_GIF1_RA_D3.dat");
E2F_data_scaled = readdlm("./plot_best/scaled_data_E2F_RA_D3.dat");
CEBPa_data_scaled = readdlm("./plot_best/scaled_data_CEBPa_RA_D3.dat");
OCT4_data_scaled = readdlm("./plot_best/scaled_data_OCT4_RA_D3.dat");

# Load the measurements -
CD38_EXP = readdlm("./data/CD38-WTHL60_RA_D3.txt");
CD14_EXP = readdlm("./data/CD14-WTHL60_RA_D3.txt");
CD11b_EXP = readdlm("./data/CD11b-WTHL60_RA_D3.txt");
G1G0_EXP = readdlm("./data/G1G0-WTHL60_RA_D3.txt");
...
y_exp_std = [
  ...
  CEBPa_RA_D3_EXP[2,3]
  PU1_RA_D3_EXP[2,3]
  P47Phox_RA_D3_EXP[2,3]
  OCT4_RA_D3_EXP[2,3]
]

fig = figure("RA",figsize=(10,20))
a = bar(x,y,color="#0f87bf",align="center",alpha=0.4, yerr = y_sim_std)
b = bar(x,y,color="salmon",align="center",alpha=0.4, yerr = y_exp_std)
axis("tight")
