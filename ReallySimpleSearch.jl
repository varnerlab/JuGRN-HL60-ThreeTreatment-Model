...
for sample_index in collect(68:168)
  # Load the parameter array -
  previous_parameter_array = readdlm("./parameter_best_v1.dat")
  ...
  for index = 1:length(parameter_mapping_array)
    ...
    @show sample_index
    writedlm("./parameter_best_v1.dat",parameter_array);
    writedlm("./parameter_best_v1.dat."*string(sample_index),parameter_array)
  end
end
